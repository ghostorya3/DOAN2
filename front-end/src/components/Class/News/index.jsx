    ...
    return (
        <div className="w-screen flex justify-center items-center flex-col">
            <div className="w-[60%] mt-10 relative">
                ...
                <div className="absolute bottom-5 left-5 text-white text-3xl font-semibold"> Lập trình phân tán</div>
            </div>
            <div className="flex border rounded-2xl shadow-xl gap-3 p-4 mt-5  justify-start items-center w-[60%]">
                <div className="w-10 h-10 ">
                    <Image src={'/277894110_720178642472643_59267636986975849_n.jpg'} attribute={'border rounded-full'}></Image>
                </div>
